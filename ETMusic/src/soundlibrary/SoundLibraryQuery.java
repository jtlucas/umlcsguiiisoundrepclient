...
public class SoundLibraryQuery {
    ...
    public Vector<SoundLibraryEntry> executeQuery() throws Exception{
        //Create query by adding base URL and query
        String url_string = page_url + query;
        //We'll have to encode the url_string here. URLEncoder will replace ' '
        //with '+' and do a few other things we don't want. We'll have to handle
        //our special characters here.
        //Replace instaces of " " with "%20"
        ...
        //Now extract each Entry and add it to the Vector
        results = new Vector<SoundLibraryEntry>();
        //Navigate the tree and pull out the data
        NodeList entries = document.getElementsByTagName( "Entry" );
        //For each entry, create a SoundLibraryEntry
