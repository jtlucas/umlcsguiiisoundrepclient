...
public class SoundLibraryEntry {
    ...
    /**
     * The URL, date, and Sequence number are server-generated and may not be
     * set. Alterations to these will be IGNORED on an upload or an update.
     */
